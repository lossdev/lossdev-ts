...
export const SpecialtiesContainer = ({children}: React.PropsWithChildren<{}>) => {
    ...
    <React.Fragment>
        <div className="flex flex-col w-full">
            <ul className="ml-5 mb-14 flex flex-col gap-y-2 list-outside">
                ...
                <li className="font-jbmono-light text-slate-50 text-md">
                    <FontAwesomeIcon icon={faUser} className="mr-4 w-12 opacity-0" />Cybersecurity
                </li>
                <li className="font-jbmono-light text-slate-50 text-md">
                    <FontAwesomeIcon icon={faUser} className="mr-4 w-12 opacity-0" />DevOps
                </li>
                ...
                <li className="font-jbmono-light text-slate-50 text-md">
                    <FontAwesomeIcon icon={faMicrochip} className="mr-4 w-12 opacity-0" />Docker, Kubernetes, SQL
                </li>
            </ul>
        </div>
    </React.Fragment>
